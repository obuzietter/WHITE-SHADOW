<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="/" class="logo d-flex align-items-center  me-auto me-lg-0">
        ...
        <h1>White Shadow Photography</h1>
      </a>
      ...
      <div class="header-social-links">
        ...
        <a href="https://www.instagram.com/white_shadow.photography?igsh=ZDYwd2c3MTVyb2Ft" class="instagram" target="_blank"><i class="bi bi-instagram"></i></a>
        <a href="https://www.tiktok.com/@white_shadow.photography?_t=8meLHZYTp2c&_r=1" class="tiktok" target="_blank"><i class="bi bi-tiktok"></i>  </a>
